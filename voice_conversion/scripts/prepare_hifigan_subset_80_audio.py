...
"""
prepare_hifigan_subset_80_audio.py
...
- Saves WAV files in the target directory.
- Logs processing metadata to a CSV file in logs_subset_80.
"""
...
INPUT_DIR = PROJECT_ROOT / "voice_conversion" / "input_subset_80"
OUTPUT_DIR = PROJECT_ROOT / "voice_conversion" / "input_subset_80_22050"
LOG_DIR = PROJECT_ROOT / "voice_conversion" / "logs_subset_80"
CSV_LOG_PATH = LOG_DIR / "subset_80_preprocessing_log.csv"
...
def main():
    print("=" * 60)
    print("Starting HiFi-GAN Subset 80 Audio Preprocessing")
    ...
    if not wav_files:
        ...
        with open(CSV_LOG_PATH, mode="w", newline="", encoding="utf-8") as f:
            ...
            writer.writerow([
                ...
                "N/A", "N/A", "N/A", 
                "empty", "No WAV files are present in input_subset_80 yet"
            ])
        sys.exit(0)
