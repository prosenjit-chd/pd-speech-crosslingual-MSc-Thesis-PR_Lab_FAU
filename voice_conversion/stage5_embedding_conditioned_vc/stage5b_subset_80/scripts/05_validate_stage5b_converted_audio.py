...
"""
05_validate_stage5b_converted_audio.py

Purpose:
Validates all 80 converted WAV files in Stage 5B:
...
VALIDATION_SUMMARY_MD = LOGS_DIR / "stage5b_converted_audio_validation_summary.md"

def main():
    print("=" * 60)
    print("Stage 5B Step 5: Validating Converted WAV Files")
    print("=" * 60)
    ...
    for idx, row in df_gen.iterrows():
        ...
        output_path = STAGE5B_DIR / rel_output if rel_output else None
    ...
    clipping_ratio = clipped_files_count / total_files if total_files > 0 else 0.0
    ...
    if failed_count > 0:
        ...
        summary_md_lines.append("> **Pipeline Continue Condition Met**: All 80 converted files meet technical specifications. Proceed to classification evaluation.")
        ...
        print("PIPELINE SUCCESS: All 80 files passed validation. Proceeding.")
