...
"""
04_generate_stage5c_converted_audio.py

Purpose:
Executes prototype embedding-conditioned voice conversion on the 276 files:
...
SOURCE_EMB_PATH = STAGE5C_DIR / "source_embeddings_stage5c" / "xlsr_layer11_stage5c.csv"
DE_COND_PATH = STAGE5C_DIR / "target_domain_embeddings_stage5c" / "xlsr_layer11_german_domain_condition.csv"
SP_COND_PATH = STAGE5C_DIR / "target_domain_embeddings_stage5c" / "xlsr_layer11_spanish_domain_condition.csv"
CONVERTED_MELS_DIR = STAGE5C_DIR / "converted_mels_stage5c"
CONVERTED_AUDIO_DIR = STAGE5C_DIR / "converted_audio_stage5c"
...
def main():
    print("=" * 60)
    print("Stage 5C Step 4: Generating Converted Speech Grid")
    print("=" * 60)
    ...
    # 1. Pre-extract and cache log-mel spectrograms of the 276 files
    ...
    for idx, filename in enumerate(file_list):
        ...
        try:
            ...
            generation_logs.append({
                ...
                "condition_layer": 11,
                "alpha": alpha,
                "output_file": str(dest_audio_path.relative_to(STAGE5C_DIR)),
